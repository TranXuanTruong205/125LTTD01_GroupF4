...
public class CartService {
    ...
    public Cart getCartByUser(String phoneNumber) {
    ...
    @Transactional
    public Cart addToCart(String phoneNumber, Integer menuItemId, Integer quantity) {
        Cart cart = getCartByUser(phoneNumber);
        ...
        if (existingItem.isPresent()) {
            ...
            newItem.setPrice(item.getPrice()); // Hoặc discountPrice nếu có
    ...
    @Transactional
    public Cart updateQuantity(String phoneNumber, Integer cartItemId, Integer quantity) {
        Cart cart = getCartByUser(phoneNumber);
    ...
    @Transactional
    public void removeCartItem(String phoneNumber, Integer cartItemId) {
        Cart cart = getCartByUser(phoneNumber);
